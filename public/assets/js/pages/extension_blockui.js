...
$(function() {
    ...
    $('#custom-message').on('click', function() {
        var block = $(this).parent();
        $(block).block({
        	message: '<span class="text-semibold"><i class="ph-spinner spinner position-left"></i>&nbsp; Updating data</span>',
        	timeout: 2000, //unblock after 2 seconds
            overlayCSS: {
                backgroundColor: '#fff',
                opacity: 0.8,
    ...
    $('#multiple-messages').on('click', function() {
        ...
        window.setTimeout(function () {
           message.html('<i class="ph-spinner spinner"></i> <span class="text-semibold display-block">Loading</span>')
        }, 0); 

        window.setTimeout(function () {
           message.html('<i class="ph-spinner spinner"></i> <span class="text-semibold display-block">Please wait</span>')
        }, 2000); 
