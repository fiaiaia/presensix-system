...
$(function() {
    ...
    $(".select-search-rent").each(function() {
        $(this)
    ...
    $('.select-search-add-project').select2({
        dropdownParent: $('#modal_add_project')
    });

    $('.select-search-edit-project').select2({
        dropdownParent: $('#modal_edit_project')
    });

    // Select with search
    $('.select-search-agent').select2({
        width: '100%',
